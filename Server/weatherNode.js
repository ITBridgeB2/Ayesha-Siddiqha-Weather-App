...
//   if (result.length === 0) {
//     return response.status(204).json("City not found");
//   } else {
//     return response.status(200).json(result[0]); // returns temperature, humidity, and weather
//   }
// });
// app.listen("9099")
// console.log("weather app started on 9099 port")